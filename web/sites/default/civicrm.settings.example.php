...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:drupal@localhost:3306/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupal:drupal@localhost:3306/drupal?new_link=true');
  }
}
...
$civicrm_root = '/var/www/drupalvm/vendor/civicrm/civicrm-core';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/drupalvm/web/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://hm-public.test');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '16e73ee9f8d64d56a1ebe8771653d8d8');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/drupalvm/web/sites/default/files/civicrm/templates_c//mail.log');
// }
